...
N_ants=20; %define number of ants in colony (i.e. number of objects)
...
for k=1:length(tvec)
    ...
    %[antColony.friendDesire]=deal([antColony(1).friendDesire]-0.01); %Increase food desire as time increases
